...
namespace PedidosApp
{
    public partial class FrmTrabajador : Form
    {
        ...
        private static FrmTrabajador _Instancia;
        public static FrmTrabajador GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmTrabajador();
            }
            return _Instancia;
        }
        public void MostrarEquipoSeleccionado(string idEquipo, string nombreEquipo)
        {
            // Asignamos los valores a los TextBox correspondientes
            this.txtIdequipo.Text = idEquipo;
            this.txtequipo.Text = nombreEquipo;
        }
        ...
        private void Botones()
        {
            ...
            {
                this.Habilitar(true);  // Habilitar controles si se edita o inserta
            ...
            {
                this.Habilitar(false);  // Deshabilitar controles si no se edita o inserta
            ...
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        ...
                        //int equipoSeleccionado = Convert.ToInt32(comboBoxEquipos.SelectedValue);
                        ...
                        Convert.ToInt32(txtIdequipo.Text)); // Convertir txtIdequipo.Text a entero);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (!this.txtIdtrabajador.Text.Equals(""))
            {
                ...
                // Mostrar el ID del trabajador pero no permitir la edición
                this.txtIdtrabajador.Visible = true;
                this.txtIdtrabajador.ReadOnly = true;  // El campo sigue siendo de solo lectura
            }
            else
            {
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            if (dataListado.CurrentRow != null)
            {
                ...
                this.cbSexo.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["sexo"].Value); // Usa el índice aquí
                dtFecha_Nacimiento.Value = Convert.ToDateTime(this.dataListado.CurrentRow.Cells["fecha_nac"].Value);
                ...
                this.txtequipo.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["nombre_equipo"].Value);
        ...
        //{
        //    comboBoxEquipos.DataSource = NTrabajador.MostrarEquipos();
        //    comboBoxEquipos.DisplayMember = "nombreEquipo";
        //    comboBoxEquipos.ValueMember = "idEquipo";
        //}

        private void btnBuscarCategoria_Click(object sender, EventArgs e)
        {
            //FrmVistaEquipo_Trabajador form = new FrmVistaEquipo_Trabajador();
            //form.ShowDialog();
        }
        ...
        {
            // Crear una nueva instancia de FrmVistaEquipo_Trabajador y pasar la referencia de este formulario
            FrmVistaEquipo_Trabajador vistaEquipoForm = new FrmVistaEquipo_Trabajador(this);
            vistaEquipoForm.ShowDialog();  // Mostrar el formulario de selección
        }
    }
}
