...
namespace PedidosApp
{
    public partial class FrmEquipos : Form
    {
        ...
        {
            InitializeComponent();
            //this.txtMensaje.SetToolTip(this.txtNombre, "Ingrese el Nombre del Equipo");
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NEquipo.Insertar(this.txtNombre.Text.Trim().ToUpper());
                    }
                    else
                    {
                        rpta = NEquipo.Editar(Convert.ToInt32(this.txtIdEquipo.Text),
        ...
        {
            //Reportes.FrmReporteEquipo frm = new Reportes.FrmReporteEquipo();
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.txtNombre.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["nombre_equipo"].Value);
